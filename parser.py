...
parser.add_argument('--train-file', default='/Users/wangyihao/Pycharm/transformer-simple-master_new/data/data2.p')
parser.add_argument('--dev-file', default='/Users/wangyihao/Pycharm/transformer-simple-master_new/data/test_data_10000.p')
...
parser.add_argument('--epochs', default=4, type=int) # 训练轮数
parser.add_argument('--layers', default=3, type=int) # transformer层数
